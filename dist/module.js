define(["angular","app/core/utils/datemath","app/plugins/sdk","lodash"], function(__WEBPACK_EXTERNAL_MODULE_angular__, __WEBPACK_EXTERNAL_MODULE_grafana_app_core_utils_datemath__, __WEBPACK_EXTERNAL_MODULE_grafana_app_plugins_sdk__, __WEBPACK_EXTERNAL_MODULE_lodash__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
var AtsdDatasource = /** @class */function () {
    ...
    AtsdDatasource.prototype._convertTargetToQuery = function (target) {
        ...
        var query = {
            ...
            tagCombos: _angular2.default.copy(target.tagCombos),
            implicit: _angular2.default.copy(target.implicit),
            tags: {},
